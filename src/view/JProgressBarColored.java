...
public class JProgressBarColored extends JComponent {
    ...
    private volatile Color foregroundColor = Color.green; // foreground color of progress bar
...
* @param maximumValue
    ...
    protected void paintComponent(Graphics g) {
        ...
        g2d.setRenderingHint(RenderingHints.KEY_ANTIALIASING, RenderingHints.VALUE_ANTIALIAS_ON); // set rendering hints
    ...
    private void drawForground(Graphics2D g2d) {
        ...
        g2d.fillRect(hPadding / 2, vPadding / 2, (int) ((getWidth() - hPadding) / ((maximumValue * accuracy) / (value * accuracy))), getHeight()
                - vPadding);
    }
